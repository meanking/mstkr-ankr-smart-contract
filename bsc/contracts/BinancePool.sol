...
contract BinancePool is PausableUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
     ...
     */
    function claimToIntermediary(address payable intermediary) public onlyOperator payable {
        ...
        require(_pegEthContract.transfer(intermediary, total), "Couldn't transfer ether");
    ...
    function stake(uint256 amount) public nonReentrant {
        uint256 fee = amount % REQUESTER_MINIMUM_POOL_STAKING;
        amount = amount - fee;
        ...
        require(_pegEthContract.transferFrom(msg.sender, address(this), amount), "Couldn't transfer Peg-ETH");
