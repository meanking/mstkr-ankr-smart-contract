...
contract BinancePool_R6 is PausableUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable, IGlobalPool {
    ...
    function claimToIntermediary(address payable intermediary, uint256 networkFee, uint256 threshold) public onlyOperator payable {
        ...
        if (total < threshold || total == threshold && i == _pendingStakers.length && gaps > 0) {
